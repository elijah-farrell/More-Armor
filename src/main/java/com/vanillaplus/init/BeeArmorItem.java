...
public class BeeArmorItem extends ArmorItem {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (slot == EquipmentSlot.LEGS) {
            ...
            return "vanillaplus:textures/models/averagetateman/armor/bee/layer_2.png";
        } else {
            ...
            return String.format("vanillaplus:textures/models/averagetateman/armor/bee/layer_1_frame%d.png", frame);
        }
    }
} 