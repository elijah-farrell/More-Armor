...
public class MachineArmorItem extends ArmorItem {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (slot == EquipmentSlot.LEGS) {
            ...
            return String.format("morearmor:textures/models/averagetateman/armors/machine/layer_2_frame%d.png", layer2Frame);
        } else {
            ...
            return String.format("morearmor:textures/models/averagetateman/armors/machine/layer_1_frame%d.png", layer1Frame);
        }
    }
} 