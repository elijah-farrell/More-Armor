...
import com.morearmor.init.animations.*;
...
public class Items {
    ...
    public static final RegistryObject<Item> ANCIENT_DEBRIS_HELMET = ITEMS.register("ancient_debris_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ancient_debris"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> ANCIENT_DEBRIS_CHESTPLATE = ITEMS.register("ancient_debris_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ancient_debris"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> ANCIENT_DEBRIS_LEGGINGS = ITEMS.register("ancient_debris_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ancient_debris"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> ANCIENT_DEBRIS_BOOTS = ITEMS.register("ancient_debris_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ancient_debris"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Amethyst Armor Set
    public static final RegistryObject<Item> AMETHYST_HELMET = ITEMS.register("amethyst_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("amethyst"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> AMETHYST_CHESTPLATE = ITEMS.register("amethyst_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("amethyst"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> AMETHYST_LEGGINGS = ITEMS.register("amethyst_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("amethyst"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> AMETHYST_BOOTS = ITEMS.register("amethyst_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("amethyst"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Bedrock Armor Set
    public static final RegistryObject<Item> BEDROCK_HELMET = ITEMS.register("bedrock_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bedrock"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> BEDROCK_CHESTPLATE = ITEMS.register("bedrock_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bedrock"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> BEDROCK_LEGGINGS = ITEMS.register("bedrock_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bedrock"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> BEDROCK_BOOTS = ITEMS.register("bedrock_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bedrock"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> BONE_HELMET = ITEMS.register("bone_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bone"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> BONE_CHESTPLATE = ITEMS.register("bone_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bone"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> BONE_LEGGINGS = ITEMS.register("bone_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bone"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> BONE_BOOTS = ITEMS.register("bone_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("bone"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Cactus Armor Set
    public static final RegistryObject<Item> CACTUS_HELMET = ITEMS.register("cactus_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("cactus"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> CACTUS_CHESTPLATE = ITEMS.register("cactus_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("cactus"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> CACTUS_LEGGINGS = ITEMS.register("cactus_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("cactus"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> CACTUS_BOOTS = ITEMS.register("cactus_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("cactus"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Coal Armor Set
    public static final RegistryObject<Item> COAL_HELMET = ITEMS.register("coal_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("coal"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> COAL_CHESTPLATE = ITEMS.register("coal_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("coal"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> COAL_LEGGINGS = ITEMS.register("coal_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("coal"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> COAL_BOOTS = ITEMS.register("coal_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("coal"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Copper Armor Set
    public static final RegistryObject<Item> COPPER_HELMET = ITEMS.register("copper_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("copper"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> COPPER_CHESTPLATE = ITEMS.register("copper_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("copper"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> COPPER_LEGGINGS = ITEMS.register("copper_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("copper"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> COPPER_BOOTS = ITEMS.register("copper_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("copper"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Crafting Armor Set
    public static final RegistryObject<Item> CRAFTING_HELMET = ITEMS.register("crafting_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("crafting"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> CRAFTING_CHESTPLATE = ITEMS.register("crafting_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("crafting"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> CRAFTING_LEGGINGS = ITEMS.register("crafting_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("crafting"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> CRAFTING_BOOTS = ITEMS.register("crafting_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("crafting"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Dripstone Armor Set
    public static final RegistryObject<Item> DRIPSTONE_HELMET = ITEMS.register("dripstone_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("dripstone"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> DRIPSTONE_CHESTPLATE = ITEMS.register("dripstone_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("dripstone"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> DRIPSTONE_LEGGINGS = ITEMS.register("dripstone_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("dripstone"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> DRIPSTONE_BOOTS = ITEMS.register("dripstone_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("dripstone"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Emerald Armor Set
    public static final RegistryObject<Item> EMERALD_HELMET = ITEMS.register("emerald_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("emerald"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> EMERALD_CHESTPLATE = ITEMS.register("emerald_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("emerald"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> EMERALD_LEGGINGS = ITEMS.register("emerald_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("emerald"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> EMERALD_BOOTS = ITEMS.register("emerald_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("emerald"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> GILDED_HELMET = ITEMS.register("gilded_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("gilded"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_CHESTPLATE = ITEMS.register("gilded_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("gilded"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_LEGGINGS = ITEMS.register("gilded_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("gilded"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_BOOTS = ITEMS.register("gilded_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("gilded"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Glass Armor Set
    public static final RegistryObject<Item> GLASS_HELMET = ITEMS.register("glass_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("glass"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> GLASS_CHESTPLATE = ITEMS.register("glass_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("glass"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> GLASS_LEGGINGS = ITEMS.register("glass_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("glass"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> GLASS_BOOTS = ITEMS.register("glass_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("glass"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> LAPIS_HELMET = ITEMS.register("lapis_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("lapis"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> LAPIS_CHESTPLATE = ITEMS.register("lapis_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("lapis"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> LAPIS_LEGGINGS = ITEMS.register("lapis_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("lapis"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> LAPIS_BOOTS = ITEMS.register("lapis_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("lapis"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> POWER_SUIT_HELMET = ITEMS.register("power_suit_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("power_suit"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> POWER_SUIT_CHESTPLATE = ITEMS.register("power_suit_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("power_suit"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> POWER_SUIT_LEGGINGS = ITEMS.register("power_suit_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("power_suit"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> POWER_SUIT_BOOTS = ITEMS.register("power_suit_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("power_suit"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Quartz Armor Set
    public static final RegistryObject<Item> QUARTZ_HELMET = ITEMS.register("quartz_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("quartz"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> QUARTZ_CHESTPLATE = ITEMS.register("quartz_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("quartz"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> QUARTZ_LEGGINGS = ITEMS.register("quartz_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("quartz"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> QUARTZ_BOOTS = ITEMS.register("quartz_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("quartz"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> REDSTONE_HELMET = ITEMS.register("redstone_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("redstone"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> REDSTONE_CHESTPLATE = ITEMS.register("redstone_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("redstone"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> REDSTONE_LEGGINGS = ITEMS.register("redstone_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("redstone"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> REDSTONE_BOOTS = ITEMS.register("redstone_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("redstone"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> REINFORCED_DEEPSLATE_HELMET = ITEMS.register("reinforced_deepslate_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("reinforced_deepslate"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> REINFORCED_DEEPSLATE_CHESTPLATE = ITEMS.register("reinforced_deepslate_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("reinforced_deepslate"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> REINFORCED_DEEPSLATE_LEGGINGS = ITEMS.register("reinforced_deepslate_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("reinforced_deepslate"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> REINFORCED_DEEPSLATE_BOOTS = ITEMS.register("reinforced_deepslate_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("reinforced_deepslate"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> RUBY_HELMET = ITEMS.register("ruby_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ruby"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> RUBY_CHESTPLATE = ITEMS.register("ruby_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ruby"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> RUBY_LEGGINGS = ITEMS.register("ruby_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ruby"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> RUBY_BOOTS = ITEMS.register("ruby_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("ruby"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> SHULKER_HELMET = ITEMS.register("shulker_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("shulker"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> SHULKER_CHESTPLATE = ITEMS.register("shulker_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("shulker"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> SHULKER_LEGGINGS = ITEMS.register("shulker_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("shulker"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> SHULKER_BOOTS = ITEMS.register("shulker_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("shulker"), ArmorItem.Type.BOOTS, new Item.Properties()));

    // Skeleton Armor Set
    public static final RegistryObject<Item> SKELETON_HELMET = ITEMS.register("skeleton_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("skeleton"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> SKELETON_CHESTPLATE = ITEMS.register("skeleton_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("skeleton"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> SKELETON_LEGGINGS = ITEMS.register("skeleton_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("skeleton"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> SKELETON_BOOTS = ITEMS.register("skeleton_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("skeleton"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> TOTEM_HELMET = ITEMS.register("totem_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("totem"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> TOTEM_CHESTPLATE = ITEMS.register("totem_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("totem"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> TOTEM_LEGGINGS = ITEMS.register("totem_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("totem"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> TOTEM_BOOTS = ITEMS.register("totem_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("totem"), ArmorItem.Type.BOOTS, new Item.Properties()));
    ...
    public static final RegistryObject<Item> WITHER_SKELETON_HELMET = ITEMS.register("wither_skeleton_helmet",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("wither_skeleton"), ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> WITHER_SKELETON_CHESTPLATE = ITEMS.register("wither_skeleton_chestplate",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("wither_skeleton"), ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> WITHER_SKELETON_LEGGINGS = ITEMS.register("wither_skeleton_leggings",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("wither_skeleton"), ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> WITHER_SKELETON_BOOTS = ITEMS.register("wither_skeleton_boots",
            () -> new CustomArmorItem(ArmorConfigLoader.getMaterial("wither_skeleton"), ArmorItem.Type.BOOTS, new Item.Properties()));
