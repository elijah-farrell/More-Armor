...
public class MusicArmorItem extends ArmorItem {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (slot == EquipmentSlot.LEGS) {
            ...
            return "morearmor:textures/models/averagetateman/armors/music/layer_2.png";
        } else {
            ...
            return String.format("morearmor:textures/models/averagetateman/armors/music/layer_1_frame%d.png", frame);
        }
    }
} 